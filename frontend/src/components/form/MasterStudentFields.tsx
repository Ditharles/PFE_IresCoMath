...
interface MasterStudentFieldsProps {
    form: UseFormReturn<InscriptionFormData>
}

export const MasterStudentFields: React.FC<MasterStudentFieldsProps> = ({ form }) => {
    ...
    return (
        <div className="space-y-4">
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        <FormLabel>Année de master</FormLabel>
                        <FormControl>
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                            ...
                            >
                                <SelectTrigger>
                                    <SelectValue placeholder="Sélectionner votre encadrant" />
                                </SelectTrigger>
                                <SelectContent>
