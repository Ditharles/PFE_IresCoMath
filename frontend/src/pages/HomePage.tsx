          ...
          <div className={`md:col-span-1 p-4 rounded-lg shadow ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
            <nav>
              <ul className="space-y-4">
                <li>
                  <button className={`w-full text-left px-4 py-2 rounded-md font-medium ${darkMode ? 'bg-blue-900 text-blue-100' : 'bg-blue-100 text-blue-700'}`}>
                    Historique
                  </button>
                </li>
                <li>
                  <button className={`w-full text-left px-4 py-2 rounded-md font-medium ${darkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-100'}`}>
                    Nouvelle Demande
                  </button>
                </li>
                <li>
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <div className={`p-4 rounded-lg shadow ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  <label className={`block text-sm font-medium mb-1 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>Date début</label>
                  <input
                    type="date"
                ...
                <div>
                  <label className={`block text-sm font-medium mb-1 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>Date fin</label>
                  <input
                    type="date"
                    className={`w-full p-2 border rounded-md ${darkMode ? 'bg-gray-700 border-gray-600 text-white' : 'border-gray-300'}`}
                    value={endDate}
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className={`divide-y ${darkMode ? 'divide-gray-700' : 'divide-gray-200'}`}>
                    {filteredRequests.map((request) => (
                      <tr key={request.id} className={darkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-white hover:bg-gray-50'}>
